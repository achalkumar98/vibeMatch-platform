    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          {[
            { icon: "⚡", text: "Swipe through developer profiles" },
            { icon: "💬", text: "Real-time chat with Socket.IO" },
            { icon: "📊", text: "Admin analytics dashboard" },
            { icon: "💎", text: "Premium plans via Razorpay" },
          ].map((f, i) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-white/40 mb-8">Start connecting with developers worldwide</p>
